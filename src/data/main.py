...
folder_path = 'C:/Users/ilso_/OneDrive/Área de Trabalho/Python/make_data_netflix/src/data/raw'
...
if dfs:
   ...
   result = pd.concat(dfs, ignore_index=True)
    ...
    #caminho de saída
   output_file = os.path.join('C:/Users/ilso_/OneDrive/Área de Trabalho/Python/make_data_netflix/src/data/ready', 'clean.xlsx')
